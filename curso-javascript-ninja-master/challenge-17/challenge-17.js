...
*/
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Mário Cesar"));
...
*/
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/, "O Centauro de Luvas".toUpperCase())
  );
...
*/
  ...
  var regexDate = /([1-30])(\06\07)(\1804\1875)/;
...
*/
  ...
  function replaceDate(string) {
    let day = string.replace(/\d\d/g, "xx");
    let month = string.replace(/junho/, getMonthNumber("junho"));
    let year = string.replace();
